...
describe("CourseController", () => {
  ...
  describe("findAllCourses", () => {
    it("should return a list of courses", async () => {
      const mockCourses = [
        { id: new ObjectId(), name: "Course 1", codCourse: "C1", model: "in-person" },
        { id: new ObjectId(), name: "Course 2", codCourse: "C2", model: "blended" },
      ];
  ...
  describe("createCourse", () => {
    it("should create a course successfully", async () => {
      const mockCourse: CourseType = {
        ...
        professors: [],
        coordinator: { id: new ObjectId(), name: "John Doe", email: "john@example.com" },
      };
